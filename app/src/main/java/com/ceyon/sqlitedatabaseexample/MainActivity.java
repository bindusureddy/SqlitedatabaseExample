package com.ceyon.sqlitedatabaseexample;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editSurname = (EditText) findViewById(R.id.edsurname);
        editMarks = (EditText) findViewById(R.id.edmarks);
        editTextId = (EditText) findViewById(R.id.edid);
    ...
    public void UpdateData() {
        btnviewUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isUpdate == true) Toast.makeText(MainActivity.this, "Data Update", Toast.LENGTH_LONG).show();
